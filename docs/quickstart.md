...
```bash
uvx --from git+https://github.com/DauQuangThanh/OnSpecKit.git specify init <PROJECT_NAME> --script ps  # Force PowerShell
uvx --from git+https://github.com/DauQuangThanh/OnSpecKit.git specify init <PROJECT_NAME> --script sh  # Force POSIX shell
```
